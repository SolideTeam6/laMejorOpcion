...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { active: @station.active, address: @station.address, lat: @station.lat, logo: @station.logo, long: @station.long, name: @station.name }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { active: @station.active, address: @station.address, lat: @station.lat, logo: @station.logo, long: @station.long, name: @station.name }
    assert_redirected_to station_path(assigns(:station))
  end
